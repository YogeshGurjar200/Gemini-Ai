    ...
    <>
      ...
      <div className="flex flex-col h-screen overflow-x-clip">
        <div className="flex ">
          <div
            className={`flex items-center ${
              expanded ? "justify-end w-64" : "justify-start w-16"
            } p-2 bg-base-200 border-r border-base-300 transition-all duration-300 ${
              !expanded && "sm:w-16"
            }`}
          >
            <button
            ...
            >
              {expanded ? <HiX size={20} /> : <HiMenu size={20} />}
            </button>
          </div>
        ...
        <div className="flex h-screen ">
          {/* Sidebar */}
          <div ref={sidebarRef} className="flex flex-col h-full bg-base-200">
            {/* <div
              className={`flex items-center ${
                expanded ? "justify-end w-64" : "justify-start w-16"
              } p-2 bg-base-200 border-r border-base-300 transition-all duration-300 ${
